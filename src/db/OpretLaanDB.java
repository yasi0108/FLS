...
//    private int laanestatus;
	...
	public void createLaan(int tlf, String udbetalingGetText, String laanleangdeGetText, double rente, double mdlydelse,
			double samletpris) {
		...
		try {
			...
			statement.executeUpdate(
					"INSERT INTO laanetilbud  (telefonnummer,kundeindbetaling,laanlaengde,rente,mdlydelse, samletpris) VALUES ('"
							+ tlf + "', '" + udbetalingGetText + "', '" + laanleangdeGetText + "', '" + rente + "','"
							+ mdlydelse + "', '" + samletpris + "')");
