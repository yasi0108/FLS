...
public class OpdaterKundeDB {
	public void kundeOpdatering(String fornavnGT, String efternavnGT, String tlfGT, String postnrGT, String byGT,
...
//					+ "', '" + CreatePassword + "')");
			...
			statement.executeUpdate(("UPDATE kunde SET kundefornavn = '" + fornavnGT + "', kundeefternavn = '"
					+ efternavnGT + "', cpr_nummer = '" + cprGT + "', mail = '" + mailGT + "', postnummer = '"
					+ postnrGT + "', bynavn = '" + byGT + "', vejnavn = '" + vejGT + "', husnr = '" + husnrGT
